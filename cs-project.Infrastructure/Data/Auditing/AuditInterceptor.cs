...
public class AuditInterceptor : SaveChangesInterceptor
{
    ...
    public AuditInterceptor(ICurrentUserAccessor userAccessor)
    {
        ...
        try
        {
            ...
            if (logs.Count > 0)
            {
                foreach (var log in logs)
                    AuditWriterService.Queue.Writer.TryWrite(log);
            }
    ...
    private static string Serialize(object obj) //suitable with cencoring sensitive fields with [DoNotAudit] 
    {
